...
use Fykosak\FKSDBDownloaderCore\Requests\{Event\ParticipantsListRequest, Event\TeamsListRequest, EventListRequest, ExportRequest, SignaturesRequest};
...
$result = $downloader->download(new SignaturesRequest(2));
